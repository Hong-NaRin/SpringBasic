...
@ContextConfiguration("file:src/main/webapp/WEB-INF/config/root-context.xml") // 내가 동작시킬 파일
public class JdbcTest {
	
	// DB연결
	@Autowired
	DataSource ds; // root-context.xml에 선언되어 있는 디비 정보를 담은 객체
...
//	SqlSessionFactory sqlSessionFactory;
	...
	public void testCode02() {
		String time = testMapper.getTime(); // 추상 메서드
		System.out.println(time);
	}
}