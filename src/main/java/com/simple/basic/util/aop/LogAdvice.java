...
public class LogAdvice {
	...
	// 해당 클래스에서 로그를 사용함 (base패키지 밑에 존재해야 사용할 수 있음)
...
//				  )	
	public void execptionLog(Exception e) {
		System.out.println("advice 에러 로그: " + e);
	}
	
	// @Around - after, before, afterThrowing 세 가지를 결합해서, 처리할 수 있게 해주는 어노테이션
	...
	public Object arroundLog(ProceedingJoinPoint jp) {
		...
		try {
			...
			String path = "\\Users\\narin\\Desktop\\course\\spring\\spring_log\\오늘날짜_log.txt";
		...
		return result; // 메서드가 정상 흐름으로 돌아감
	}
}
